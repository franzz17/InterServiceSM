...
urlpatterns = [
    ...
    path('solicitud-revision/', views.solicitud_revision_view, name='solicitud_revision'),
    ...
    # API Endpoints
    path('api/cliente/<str:cedula>/', views.api_cliente, name='api_cliente'),

    path('api/aprobadas/<str:cedula>/', views.api_aprobadas, name='api_aprobadas'),
]
