...
5. **API REST**: Permite consultar información de clientes por su número de cédula
...
5. **Consulta API**:
   - Acceso a información básica de clientes mediante API REST
   - Permite verificar estado y detalles de servicio por número de cédula
